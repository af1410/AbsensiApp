...
class KaryawanController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Ambil data dari tabel users, hrds, dan HRDs
        $usersQuery = User::query();
        $hrdsQuery = Admin::query();
        $HRDsQuery = HRD::query();
        ...
        return view('hrd.karyawan.index', compact('users', 'hrds', 'HRDs', 'jabatan', 'jabatanList'));
    }
    ...
    public function create()
    {
        ...
        // Kirim kode ke view
        return view('hrd.karyawan.create', compact('newKode'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hrd.karyawan.index')->with('success', 'Karyawan berhasil ditambahkan.');
    }

    public function edit($id)
    {
        $user = User::findOrFail($id);
        return view('hrd.karyawan.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            'name' => 'required|string|max:255',
            'email' => 'required|string|email|max:255|unique:hrds,email,' . $id,
        ]);

        $karyawan = User::findOrFail($id);
        $karyawan->update($request->all());

        return redirect()->route('hrd.karyawan.index')->with('success', 'Karyawan berhasil diupdate.');
    }
    ...
    {
        $users = User::all();
        return view('hrd.karyawan.print', compact('users'));
    }
}
