...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color: #989da1;">
    <div class=" wrapper">
        ...
        <!-- Main Header -->
        @include('hrd.layouts.header') <!-- Sesuaikan dengan lokasi header Anda -->

        <!-- Sidebar -->
        @include('hrd.layouts.sidebar') <!-- Sesuaikan dengan lokasi sidebar Anda -->
        ...
        <!-- Footer -->
        @include('hrd.layouts.footer') <!-- Sesuaikan dengan lokasi footer Anda -->
