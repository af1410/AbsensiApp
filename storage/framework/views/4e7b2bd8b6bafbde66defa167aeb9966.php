        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('hrd.karyawan.update', $user->id)); ?>" method="POST">
                            <?php if($errors->any()): ?>
...
<?php echo $__env->make('hrd.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/hrd/karyawan/edit.blade.php ENDPATH**/ ?>