...
<div class="content-wrapper ml-5 pr-5 pt-5">
    <div class="container-fluid pt-2 mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <h3 class="text-center pt-4 pb-4 text-light" style="background-color: #1e90ff;"><b>Tambah Data</b></h3>
                    <div class="card-body">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/admin/admin/create.blade.php ENDPATH**/ ?>