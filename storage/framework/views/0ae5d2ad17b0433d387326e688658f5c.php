...
<body class="hold-transition sidebar-mini layout-fixed" style="background-color: #989da1;">
    <div class=" wrapper">
        ...
        <!-- Main Header -->
        <?php echo $__env->make('hrd.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Sesuaikan dengan lokasi header Anda -->

        <!-- Sidebar -->
        <?php echo $__env->make('hrd.layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Sesuaikan dengan lokasi sidebar Anda -->
        ...
        <!-- Footer -->
        <?php echo $__env->make('hrd.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Sesuaikan dengan lokasi footer Anda -->
...
</html><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/hrd/layouts/app.blade.php ENDPATH**/ ?>