                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <!-- Form Absensi -->
                            <form method="POST" action="<?php echo e(route('admin.absen.store')); ?>">
                                <?php echo csrf_field(); ?>
                                <!-- Tabel Data Absensi -->
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/admin/absen/index.blade.php ENDPATH**/ ?>