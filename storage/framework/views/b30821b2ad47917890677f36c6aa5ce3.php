...
<body>
    ...
    <div class="content">
        ...
        <div class="nav-links">
            ...
            <a href="<?php echo e(url('/dashboard')); ?>">User Dashboard</a>
            <?php else: ?>
            ...
            <?php else: ?>
            <a href="<?php echo e(route('hrd.login')); ?>">Log in as HRD</a>
            <?php endif; ?>
        </div>
    </div>

    <footer>
        <p>&copy; <?php echo e(date('Y')); ?> Absensi App. All rights reserved.</p>
    </footer>
</body>

</html><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/welcome.blade.php ENDPATH**/ ?>