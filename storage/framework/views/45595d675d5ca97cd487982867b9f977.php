...
<?php $__env->startSection('title', 'Tambah HRD'); ?>
...
<div class="content-wrapper ml-5 pr-5 pt-5" style="background-color: #989da1;">
    <div class="container-fluid pt-2 mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <h3 class="text-center pt-4 pb-4 text-light" style="background-color: #1e90ff;"><b>Tambah HRD</b></h3>
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.HRD.store')); ?>" method="POST">
                            <?php if($errors->any()): ?>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="NIK" name="NIK" value="<?php echo e($newKode); ?>" readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/admin/HRD/create.blade.php ENDPATH**/ ?>