...
<nav class="main-header navbar navbar-expand navbar-white navbar-dark fixed-top" style="background-color: #1e90ff;">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block <?php if(request()->routeIs('dashboard.*')): ?> active <?php endif; ?>">
...
</script><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/layouts/header.blade.php ENDPATH**/ ?>