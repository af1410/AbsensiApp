                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.admin.update', $admin->id)); ?>" method="POST">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="NIK" name="NIK" value="<?php echo e($admin->NIK); ?>" readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name" class="name" value="<?php echo e($admin->name); ?>" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select id="jabatan" name="jabatan" class="form-control">
                                        <option value="<?php echo e($admin->jabatan); ?>"><?php echo e($admin->jabatan); ?></option>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo e($admin->alamat); ?>">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Nomor HP</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_hp" name="no_hp" value="<?php echo e($admin->no_hp); ?>" required>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Absensi App\AbsensiApp\resources\views/admin/admin/edit.blade.php ENDPATH**/ ?>